...
def create_comment(payload: CommentCreate, use_case: CommentUseCase = Depends(get_comment_use_case)):
    try:
...
def update_comment(comment_id: int, payload: CommentUpdate, use_case: CommentUseCase = Depends(get_comment_use_case)):
    try:
...
def delete_comment(comment_id: int, use_case: CommentUseCase = Depends(get_comment_use_case)):
    try:
